...
<section className="bg-white dark:bg-gray-900 py-8 lg:py-16">
  <div className="max-w-2xl mx-auto px-4">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Discussion about us (20+)</h2>
    </div>
    <form className="mb-6">
        ...
        <button type="submit"
            className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-purple-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
            Post comment
        </button>
    </form>
    <article className="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
        <footer className="flex justify-between items-center mb-2">
            <div className="flex items-center">
                <Link className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                    <img
                        className="mr-2 w-6 h-6 rounded-full"
                        src="https://flowbite.com/docs/images/people/profile-picture-2.jpg"
                        alt="Michael Gough"/>Michael Gough</Link>
                <p className="text-sm text-gray-600 dark:text-gray-400"><time 
                        title="February 8th, 2022">Feb. 8, 2023</time></p>
            </div>
            ...
            <div className="flex items-center">
                <Link className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                    <img
                        ...
                        alt="Jese Leos"/>Jese Leos</Link>
                <p className="text-sm text-gray-600 dark:text-gray-400"><time 
                        title="February 12th, 2022">Mar. 12, 2023</time></p>
            </div>
            ...
            <div className="flex items-center">
                <Link className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                    <img
                        ...
                        alt="Bonnie Green"/>Bonnie Green</Link>
                <p className="text-sm text-gray-600 dark:text-gray-400"><time 
            ...
            <div className="flex items-center">
                <Link className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                    <img
                        ...
                        alt="Helene Engels"/>Helene Engels</Link>
                <p className="text-sm text-gray-600 dark:text-gray-400"><time  
